    ...
    describe "ensure => 'present'" do
      ...
      context "#{resource_name} doesn't exist" do
        it "should create the #{resource_name}" do
          apply_manifest(present_manifest, :expect_changes => true)
        end
      end

      context "#{resource_name} exist" do
        it 'should do nothing' do
          apply_manifest(present_manifest, :catch_changes => true)
        end
      end
    end
    ...
    if change_manifest
      describe "Changing a value" do
        ...
        it 'should change the value' do
          apply_manifest(change_manifest, :expect_changes => true)
        end
      end
    end
      ...
      describe "ensure => 'absent'" do
        ...
        context "#{resource_name} exist" do
          it "should remove the #{resource_name}" do
            apply_manifest(absent_manifest, :expect_changes => true)
          end
        end
